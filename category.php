...
<?php
  ...
  if(isset($_POST['add_data'])){
    ...
    $display_category_name = $_POST['display_category_name'];

    if(!DB::query('SELECT CategoryName FROM tb_category WHERE CategoryName=:CategoryName', array(':CategoryName'=>$display_category_name))){

      DB::query('INSERT INTO tb_category (CategoryName)
                          VALUES(:CategoryName)',
                          array(':CategoryName'=>$display_category_name));
  ...
  if(isset($_POST['delete_data'])){
    ...
    DB::query('DELETE FROM `tb_category` WHERE Id=:Id', array(':Id'=>$display_id));
  ...
  if(isset($_POST['update_data'])){
    ...
    DB::query('UPDATE tb_category SET CategoryName=:CategoryName WHERE Id=:Id', array(':CategoryName'=>$display_category_name, ':Id'=>$display_id));
...
<html lang="en" dir="ltr">
  <head>
  <title> Ingredient Stock Management System | Add / Manage Category</title>
    <meta charset="utf-8"/>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="panel panel-default">
              <div class="panel-heading"><span class="fa fa-cart-plus"></span>&nbsp;&nbsp;Add New Category</div>
              <div class="panel-body">
                <?php
                  ...
                  ?>
                <form class="form" action="category.php" method="post">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="display_category_name">Category Name</label>
                      <input class="form-control" type="text" name="display_category_name" id="display_category_name" required>
                    </div>
                    <div class="form-group">
              ...
              <div class="panel-body">
                <div class="table-responsive">
                  <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                      <?php
                        $posts_display = $mysqli->query("SELECT * FROM tb_category ORDER BY Id DESC");
                            ...
                            <form class="form" action="category.php" method="post">
                              <tr>
                                <td class="sticky-col">
                                  ...
                                  <input type="text" value="'. $posting['CategoryName'] .'" class="editable" name="display_category_name">
                                </td>
                                <td>
    ...
    <div id="deleteModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form method="POST" action="category.php" style="display: inline-block;">
